...
<?php
	...
	$koneksi->query("INSERT INTO pembelian(id_pelanggan, id_ongkir, tanggal_pembelian, total_pembelian, nama_kota, tarif, alamat_pengiriman) VALUES ('$id_pelanggan','$id_ongkir','$tanggal_pembelian','$total_pembelian','$nama_kota','$tarif','$alamat_pengirim')");
    ...
    foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) {
        ...
        $ukuran = $perproduk['ukuran']; // Ganti 'ukuran' sesuai kolom pada tabel produk
      
        $subharga = $harga * $jumlah;

        $koneksi->query("INSERT INTO pembelian_produk (id_pembelian, id_produk, nama, harga, ukuran, subharga, jumlah) VALUES ('$id_pembelian_barusan','$id_produk','$nama','$harga','$ukuran','$subharga','$jumlah')");
    }
